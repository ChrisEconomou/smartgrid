...
public class PolicyEconomy extends CustomPolicy implements HouseholdPolicy {
	...
	static final double TOLERANCE_PER=0.1;	//percentage that price can go over 0.1 -10% 0.2-20% ...1-100%
	...
	static final PolicyDay Monday=new PolicyDay(1 ,"07:00","17:00");
	static final PolicyDay Tuesday=new PolicyDay(2 ,"07:00","17:00");
	static final PolicyDay Wednesday=new PolicyDay(3 ,"07:00","17:00");
	static final PolicyDay Thursday=new PolicyDay(4 ,"07:00","17:00");
	static final PolicyDay Friday=new PolicyDay(5 ,"07:00","17:00");
	...
	static final CustomAppliance APP7= new CustomAppliance("aircondition", 150.0,2,false);

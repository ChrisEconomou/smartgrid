...
public class PolicyModerate extends CustomPolicy implements HouseholdPolicy {
	...
	static final double TOLERANCE_PER=0.3;	//percentage that price can go over 0.1 -10% 0.2-20% ...1-100%
	//static final double TOLERANCE_PER_WEEKEND=0.00;	//percentage that price can go over during weekned
	
	static final double IDEAL_ELEC_PRICE=100.0;
	//1st parameter 0-Sunday 1-Monday...6-Saturday
	//2nd parameter time owners leave home
	//3rd parameter time owners come back home
	static final PolicyDay Monday=new PolicyDay(1 ,"10:00","16:00");
	static final PolicyDay Tuesday=new PolicyDay(2 ,"10:00","16:00");
	static final PolicyDay Wednesday=new PolicyDay(3 ,"10:00","16:00");
	static final PolicyDay Thursday=new PolicyDay(4 ,"10:00","16:00");
	static final PolicyDay Friday=new PolicyDay(5 ,"10:00","16:00");
	static final PolicyDay Saturday=new PolicyDay(6 ,"12:00","14:00");
	//static final PolicyDay Sunday=new PolicyDay(0 ,"0:00","12:00");
	//CustomAppliance id-demand-priority(1 highest) state(true for open , false for closed)
	static final CustomAppliance APP1= new CustomAppliance("stereo", 51.,3,false);
	...
	static final CustomAppliance APP5= new CustomAppliance("toaster", 20.0,3,false);

...
public class ModeratePolicy implements HouseholdPolicy {
	...
	static final double PER_ABOVE=0.1;	
	static final double PER_ABOVE_WEEKEND=0.3;	
	...
	public ModeratePolicy(String iD,String author,String version,Double maxEP,Date simulationSD) {
		super();
		this.setID(iD);
